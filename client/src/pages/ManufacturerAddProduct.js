...
export default function ManufacturerAddProduct() {
  ...
  const handleSubmit = (e) => {
    ...
    formData.append('accountAddress', manAddress)
    // Send the request
    axios.post('http://localhost:8000/Manufacturer/upload', formData, {
      headers: {
  ...
  return (
    <>
      <Box>
        ...
        <Flex>
          <Sidebar />
          <Flex direction="column" mb="5" justifyContent="center" w="100%">
            <Text fontWeight="bold" align="center" fontSize="4xl" mb="3">
            ...
            <Box align="center">
              <Box>
                <Flex w="50%" direction="column">
                  ...
                  <Flex mt="2">
                    <Box alignItems="left" w="50%">
                      <FormLabel>Device Model No</FormLabel>
                    </Box>
                    <Box alignItems="left" w="50%">
                      <FormLabel>Device Color</FormLabel>
                    </Box>
                  </Flex>
                  <Flex mb="2">
                    <Input
                  ...
                  <Flex mt="2">
                    <Box alignItems="left" w="50%">
                      <FormLabel>Height in pixels</FormLabel>
                    </Box>
                    <Box alignItems="left" w="50%">
                      <FormLabel>Width in pixels</FormLabel>
                    </Box>
                  </Flex>
                  <Flex mb="2">
                    <Input
                  ...
                  <Flex mt="2">
                    ...
                    <Box alignItems="left" w="50%">
                      <FormLabel>Resolution of Screen</FormLabel>
                    </Box>
                  </Flex>
                  <Flex mb="2">
                    <Input
                  ...
                  <Flex mt="2">
                    ...
                    <Box alignItems="left" w="50%">
                      <FormLabel>Refresh Rate of Device</FormLabel>
                    </Box>
                  </Flex>
                  <Flex mb="2">
                    <Input
                  ...
                  <Flex mt="2">
                    <Box alignItems="left" w="50%">
                      <FormLabel>Smart Capable or not</FormLabel>
                    </Box>
                    <Box alignItems="left" w="50%">
                      <FormLabel>Streaming Services</FormLabel>
                    </Box>
                  </Flex>
                  <Flex mb="2">
                    <Input
                      ...
                      me="3"
                      onChange={(e) => {
                        setsmartCapable(e.target.value);
                      }}
                    />
                    <Input
                      ...
                      rows="4"
                      onChange={(e) => {
                        setfeaturedStreamingServices(e.target.value);
                      }}
                    />
                  </Flex>
                  <Flex mt="2">
                    <Box alignItems="left" w="50%">
                      <FormLabel>Screen Mirroring in device</FormLabel>
                    </Box>
                    <Box alignItems="left" w="50%">
                      <FormLabel>Total Hdmi Inputs</FormLabel>
                    </Box>
                  </Flex>
                  <Flex mb="2">
                    <Input
                      ...
                      me="3"
                      onChange={(e) => {
                        setscreenMirroring(e.target.value);
                      }}
                    />
                    <Input
                      ...
                      rows="4"
                      onChange={(e) => {
                        sethdmiInputs(e.target.value);
                      }}
                    />
                  </Flex>
                  <Flex mt="2">
                    <Box alignItems="left" w="50%">
                      <FormLabel>USB Inputs</FormLabel>
                    </Box>
                    <Box alignItems="left" w="50%">
                      <FormLabel>Compatibility with Network</FormLabel>
                    </Box>
                  </Flex>
                  <Flex mb="2">
                    <Input
                    ...
                    <Input
                      ...
                      rows="4"
                      onChange={(e) => {
                        setnetworkCompatibility(e.target.value);
                      }}
                    />
                  </Flex>
                  <Flex mt="2">
                    <Box alignItems="left" w="50%">
                      <FormLabel>No of Speakers</FormLabel>
                    </Box>
                    <Box alignItems="left" w="50%">
                      <FormLabel>Speakers Type</FormLabel>
                    </Box>
                  </Flex>
                  <Flex mb="2">
                    <Input
                    ...
                    <Input
                      ...
                      rows="4"
                      onChange={(e) => {
                        setspeakersType(e.target.value);
                      }}
                    />
                  </Flex>
                  <Flex mt="2">
                  ...
                  <Flex mb="2">
                    ...
                    <Input
                      ...
                      rows="4"
                      onChange={(e) => {
                        setwarrantyTime(e.target.value);
                      }}
                    />
                  </Flex>
                  <Flex mt="2">
